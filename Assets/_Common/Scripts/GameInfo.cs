...
public class GameInfo : MonoBehaviour
{
    ...
    public static List<GameData> allGames = new List<GameData>
    {
        ...
        new GameData("Fishing", 9, "pack_free"),           // 09_Fishing　※pack_freeなので注意
        // ボツ　ビルドに含めないこと new GameData("PianoAndViolin", 6, "pack_01"),      // 06_PianoAndViolin
        ...
        new GameData("AnimalVoice", 14, "pack_02"),        // 14_AnimalVoice
